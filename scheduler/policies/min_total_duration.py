...
class MinTotalDurationPolicy(Policy):
    ...
    def __init__(self, solver):
        ...
        self._min_total_duration_perf_policy = MinTotalDurationPolicyWithPerf(solver)

    def get_allocation(
        self, unflattened_throughputs, scale_factors, num_steps_remaining, cluster_spec
    ):
...
class MinTotalDurationPolicyWithPacking(PolicyWithPacking):
    ...
    def get_allocation(
        ...
        self._num_steps_remaining = [
            num_steps_remaining[single_job_id] for single_job_id in single_job_ids
        ]
