...
def get_policy(policy_name, solver=None, seed=None, priority_reweighting_policies=None):
    if policy_name.startswith("allox"):
        ...
        policy = finish_time_fairness.FinishTimeFairnessPolicyWithPerf(solver=solver)
    elif policy_name == "finish_time_fairness_packed":
        policy = finish_time_fairness.FinishTimeFairnessPolicyWithPacking(solver=solver)
        ...
        policy = (
            max_min_fairness_water_filling.MaxMinFairnessWaterFillingPolicyWithPerf(
                priority_reweighting_policies=priority_reweighting_policies
            )
        )
