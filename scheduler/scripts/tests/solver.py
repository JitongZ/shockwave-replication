...
def get_job_throughputs(jobs, oracle_throughputs, worker_types):
    ...
    for i, job in enumerate(jobs):
        ...
        for worker_type in worker_types:
            ...
            throughputs[job.job_id][worker_type] = oracle_throughputs[worker_type][
                job_type_key
            ]["null"]
...
def get_job_type_throughputs(jobs, oracle_throughputs, worker_types):
    ...
    for job_type_key in job_type_keys:
        ...
        for worker_type in worker_types:
            ...
            job_type_throughputs[job_type_key][worker_type][None] = oracle_throughputs[
                worker_type
            ][job_type_key]["null"]
...
def print_effective_throughputs(allocation, throughputs, job_id_to_job_type_key):
    ...
    for single_job_id in single_job_ids:
        ...
        for job_id in relevant_job_ids[single_job_id]:
            for worker_type in worker_types:
                ...
                effective_throughput += allocation[job_id][worker_type] * throughput
...
def main(args):
    ...
    oracle_throughputs = utils.read_all_throughputs_json_v2(args.throughputs_file)
    jobs = []
