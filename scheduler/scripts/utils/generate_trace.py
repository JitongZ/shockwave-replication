...
def main(args):
    ...
    durations = np.linspace(args.min_duration, args.max_duration, args.num_durations)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--num_jobs", type=int, required=True, help="Number of jobs to generate"
    )
    parser.add_argument(
        "-l", "--lam", type=float, default=0.0, help="Lambda for Poisson arrival rate"
    )
