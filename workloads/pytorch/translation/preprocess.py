...
def main():
    ...
    valid_src_word_insts, valid_tgt_word_insts = list(
        zip(
            *[
                (s, t)
                for s, t in zip(valid_src_word_insts, valid_tgt_word_insts)
                if s and t
            ]
        )
    )
    ...
    data = {
        "settings": opt,
        "dict": {"src": src_word2idx, "tgt": tgt_word2idx},
        "train": {"src": train_src_insts, "tgt": train_tgt_insts},
        "valid": {"src": valid_src_insts, "tgt": valid_tgt_insts},
    }
