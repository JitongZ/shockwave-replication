...
parser.add_argument(
    "--render", default=False, metavar="R", help="Watch game as it being played"
)
parser.add_argument(
    "--render-freq",
    type=int,
...
parser.add_argument(
    "--gpu-id", type=int, default=-1, help="GPU to use [-1 CPU only] (default: -1)"
)
parser.add_argument(
    "--skip-rate",
    type=int,
...
log = {}
setup_logger(
    "{}_mon_log".format(args.env), r"{0}{1}_mon_log".format(args.log_dir, args.env)
)
