...
@pytest.mark.parametrize("x, y, k, normalize, expected_value", test_ap_tests)
...
@pytest.mark.parametrize("x, y, k, normalize, expected_value", test_recall_tests)
...
@pytest.mark.parametrize("x, y, k, expected_value", test_recall_tests)
