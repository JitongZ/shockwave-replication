...
def dataframe_to_csr_matrix(
    dataframe, user_col, item_col, inter_col, item_id_map=None, user_id_map=None
):
    """
    ...
    csr_matrix = coo_matrix(
        (matrix_inters, (matrix_users, matrix_items)), shape=matrix_size
    ).tocsr()
