...
class Dataset(object):
    ...
    def __init__(
        self, name, data_dir=None, queue_runner_required=False, num_classes=None
    ):
        self.name = name
...
class ImageDataset(Dataset):
    ...
    def __init__(
        ...
        super(ImageDataset, self).__init__(
            name, data_dir, queue_runner_required, num_classes
        )
        self.height = height
        self.width = width
...
class ImagenetDataset(ImageDataset):
    ...
    def __init__(self, data_dir=None):
        super(ImagenetDataset, self).__init__("imagenet", 300, 300, data_dir=data_dir)
...
class Cifar10Dataset(ImageDataset):
    ...
    def read_data_files(self, subset="train"):
        ...
        all_images = np.concatenate(
            [each_input[b"data"] for each_input in inputs]
        ).astype(np.float32)
...
_SUPPORTED_INPUT_PREPROCESSORS = {
    ...
    "cifar10": {"default": preprocessing.Cifar10ImagePreprocessor},
    "librispeech": {"default": preprocessing.LibrispeechPreprocessor},
    "coco": {"default": preprocessing.COCOPreprocessor},
}
