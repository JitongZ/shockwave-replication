...
class ResNetModelTest(tf.test.TestCase):
    ...
    def _get_scaled_base_learning_rate(
        self, num_gpus, variable_update, batch_size, base_lr=None
    ):
