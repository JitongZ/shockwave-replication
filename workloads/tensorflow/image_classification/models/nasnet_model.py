...
def _large_imagenet_config(is_training=True, data_format=None, total_steps=None):
...
def build_nasnet_cifar(
    images, num_classes=None, is_training=True, data_format=None, total_steps=None
):
...
def build_nasnet_mobile(
    ...
    hparams = _mobile_imagenet_config(data_format=data_format, total_steps=total_steps)
...
class NasnetLargeModel(model.CNNModel):
    ...
    def __init__(self, params=None):
        super(NasnetLargeModel, self).__init__("nasnet", 331, 16, 0.005, params=params)
...
class NasnetCifarModel(model.CNNModel):
    ...
    def __init__(self, params=None):
        super(NasnetCifarModel, self).__init__("nasnet", 32, 32, 0.025, params=params)
