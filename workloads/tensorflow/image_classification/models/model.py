...
class Model(object):
    ...
    def __init__(
        self, model_name, batch_size, learning_rate, fp16_loss_scale, params=None
    ):
    ...
    def filter_l2_loss_vars(self, variables):
        ...
        """
        mlperf.logger.log(key=mlperf.tags.MODEL_EXCLUDE_BN_FROM_L2, value=True)
...
class CNNModel(Model):
    ...
    def build_network(self, inputs, phase_train=True, nclass=1001):
        ...
        with tf.variable_scope("cg", custom_getter=network.get_custom_getter()):
            ...
            mlperf.logger.log(
                key=mlperf.tags.MODEL_HP_FINAL_SHAPE, value=logits.shape.as_list()[1:]
            )
            aux_logits = None
