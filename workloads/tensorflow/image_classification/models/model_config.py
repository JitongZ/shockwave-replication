...
_model_name_to_imagenet_model = {
    ...
    "official_resnet18_v2": partial(official_resnet_model.ImagenetResnetModel, 18),
    "official_resnet34_v2": partial(official_resnet_model.ImagenetResnetModel, 34),
    "official_resnet50_v2": partial(official_resnet_model.ImagenetResnetModel, 50),
    "official_resnet101_v2": partial(official_resnet_model.ImagenetResnetModel, 101),
    "official_resnet152_v2": partial(official_resnet_model.ImagenetResnetModel, 152),
    "official_resnet200_v2": partial(official_resnet_model.ImagenetResnetModel, 200),
    "official_resnet18": partial(
        official_resnet_model.ImagenetResnetModel, 18, version=1
    ),
    "official_resnet34": partial(
        official_resnet_model.ImagenetResnetModel, 34, version=1
    ),
    "official_resnet50": partial(
        official_resnet_model.ImagenetResnetModel, 50, version=1
    ),
    "official_resnet101": partial(
        official_resnet_model.ImagenetResnetModel, 101, version=1
    ),
    "official_resnet152": partial(
        official_resnet_model.ImagenetResnetModel, 152, version=1
    ),
    "official_resnet200": partial(
        official_resnet_model.ImagenetResnetModel, 200, version=1
    ),
...
def get_model_config(model_name, dataset, params):
    ...
    if model_name not in model_map:
        raise ValueError(
            "Invalid model name '%s' for dataset '%s'" % (model_name, dataset.name)
        )
    else:
...
def register_model(model_name, dataset_name, model_func):
    ...
    if model_name in model_map:
        raise ValueError(
            'Model "%s" is already registered for dataset "%s"'
