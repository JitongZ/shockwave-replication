...
class NcfModel(model.Model):
  ...
  """
    ...
    def loss_function(self, inputs, build_network_result):
        ...
        return tf.losses.sparse_softmax_cross_entropy(labels=inputs[2], logits=logits)
    ...
    def get_synthetic_inputs(self, input_name, nclass):
        ...
        def users_init_val():
            return tf.random_uniform(
                (self.batch_size,), minval=0, maxval=_NUM_USERS_20M, dtype=tf.int32
            )
        ...
        def items_init_val():
            return tf.random_uniform(
                (self.batch_size,), minval=0, maxval=_NUM_ITEMS_20M, dtype=tf.int32
            )
        ...
        def labels_init_val():
            return tf.random_uniform(
                (self.batch_size,), minval=0, maxval=2, dtype=tf.int32
            )
